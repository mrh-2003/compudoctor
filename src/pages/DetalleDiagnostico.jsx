...
const FIELD_LABELS = {
    ...
    elec_video_reparable: "Tarj. Video Reparable",
    elec_placa: "Rep. Placa",
    elec_placa_reparable: "Placa Reparable",
    elec_otro: "Rep. Otro",
    elec_otro_especif: "Especif. Otro",
    elec_otro_reparable: "Otro Reparable",
...
const GROUPED_FIELDS_CONFIG = {
    ...
    elec_video: ["elec_video_reparable"],
    elec_placa: ["elec_placa_reparable"],
    elec_otro: ["elec_otro_especif", "elec_otro_reparable", "elec_codigo", "elec_etapa", "elec_obs"],
